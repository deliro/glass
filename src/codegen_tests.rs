...
#[case::string_concat("string_concat", r#"fn greet(name: String) -> String { "Hello " <> name }"#)]
...
#[case::case_bool("case_bool", "fn check(x: Bool) -> Int { case x { True -> 1 False -> 0 } }")]
#[case::case_enum("case_enum", "
pub enum Color { Red Green Blue }
fn to_int(c: Color) -> Int { case c { Red -> 1 Green -> 2 Blue -> 3 } }
")]
#[case::case_with_fields("case_with_fields", "
...
// --- Functions ---
#[case::multi_function("multi_function", "
...
#[case::enum_def("enum_def", "pub enum Phase { Lobby Playing { wave: Int } Victory { winner: Int } }")]
#[case::constructor("constructor", "
pub struct Model { wave: Int, score: Int }
fn make() -> Int { Model { wave: 1, score: 100 } }
")]
#[case::record_update("record_update", "
pub struct Model { wave: Int, score: Int }
...
#[case::list_with_type_def("list_with_type_def", "
pub struct Model { wave: Int }
fn test() -> Int { [1, 2, 3] }
")]
// --- Lambdas ---
#[case::lambda_no_capture("lambda_no_capture", "fn test() -> Int { fn(x: Int) { x + 1 } }")]
#[case::lambda_with_capture("lambda_with_capture", "fn test(y: Int) -> Int { fn(x: Int) { x + y } }")]
...
#[case::tuple_destructure("tuple_destructure", "fn first(t: Int) -> Int { let #(a, _b): Int = t a }")]
